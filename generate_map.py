...
def main():
    ...
    roadbook_html += '<details style="padding:8px 12px;background:#f0fff0;font-size:11px;border-top:2px solid #2ecc40;">'
    roadbook_html += '<summary style="cursor:pointer;font-weight:bold;color:#2ecc40;">🥤 Nutrition Plan (110g carbs/hr)</summary>'
    roadbook_html += '<div style="margin-top:6px;line-height:1.6;color:#333;">'
    roadbook_html += '<b>Pre-race:</b> Breakfast 2-3h before. Last gel 15min pre-start.<br>'
    roadbook_html += '<b>Start:</b> 2x Beta Fuel bidons (160g carbs)<br>'
    roadbook_html += '<b>km 20:</b> GEL #1 (40g)<br>'
    roadbook_html += '<b style="color:#2ecc40;">km 32 RAVITO:</b> Swap 2x bidons + CLIF bar (205g)<br>'
    roadbook_html += '<b>km 47:</b> GEL #2 pre-Arenberg (40g)<br>'
    roadbook_html += '<b style="color:#2ecc40;">km 81 RAVITO:</b> Swap 2x bidons + CLIF bar (205g)<br>'
    roadbook_html += '<b>km 94:</b> GEL #3 pre-Mons (40g)<br>'
    roadbook_html += '<b style="color:#2ecc40;">km 114 RAVITO:</b> Swap 2x bidons + CLIF bar (205g)<br>'
    roadbook_html += '<b>km 122:</b> GEL #4 pre-Finale (40g)<br>'
    roadbook_html += '<hr style="margin:4px 0;border:none;border-top:1px solid #ccc;">'
    roadbook_html += '<b>Prep: 8 packs Beta Fuel</b><br>'
    roadbook_html += '2 pre-mixed on bike + 6 packs in jersey (2 per ravito, mix on spot)<br>'
    roadbook_html += 'Total: ~852g carbs · 7.2L fluid · 4 gels · 3 CLIF bars'
    ...
    roadbook_html += f'FTP=287W · CdA=0.53 · Crr=0.007 · Mass=114kg<br>'
    roadbook_html += f'Target: {avg_pw}W avg (IF {if_val}) · {avg_spd} km/h<br>'
