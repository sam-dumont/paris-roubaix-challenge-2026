...
def main():
    ...
    roadbook_html += '<b>Start:</b> 2x Beta Fuel bidons 900ml (160g carbs)<br>'
    roadbook_html += '<b>km 20:</b> GEL #1 (40g)<br>'
    roadbook_html += '<b>km 32 RAVITO:</b> Refill 2x bidons + CLIF bar (205g)<br>'
    roadbook_html += '<b>km 47:</b> GEL #2 pre-Arenberg (40g)<br>'
    roadbook_html += '<b>km 81 RAVITO:</b> Refill 2x bidons + CLIF bar (205g)<br>'
    roadbook_html += '<b>km 94:</b> GEL #3 pre-Mons (40g)<br>'
    roadbook_html += '<b>km 114 RAVITO:</b> Refill 2x bidons + CLIF bar (205g)<br>'
    roadbook_html += '<b>km 122:</b> GEL #4 pre-Finale (40g)<br>'
    roadbook_html += '<hr style="margin:4px 0;border:none;border-top:1px solid #ccc;">'
    roadbook_html += '<b>Total: ~852g carbs · 5.3L fluid · 4 gels + 3 bars</b>'
